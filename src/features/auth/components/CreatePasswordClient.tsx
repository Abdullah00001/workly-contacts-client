...
import { CreatePassword } from '../service/auth-service';
import { Alert, AlertDescription } from '@/components/ui/alert';
import { useRouter } from 'next/navigation';

const CreatePasswordClient: FC = () => {
  ...
  return (
    <div className="flex w-full h-[70vh] flex-col items-center justify-center">
        ...
        {successMessage && (
          <Alert className="border-green-200 bg-green-50">
            ...
            <Button
              variant="ghost"
              size="sm"
              className="absolute right-2 top-2 h-6 w-6 p-0 hover:bg-green-100"
