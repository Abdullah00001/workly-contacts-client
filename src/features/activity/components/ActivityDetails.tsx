...
import { TActivityDetailsProps } from '../types/activity-type';

const ActivityDetails: FC<TActivityDetailsProps> = ({ data }) => {
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 mb-4 sm:mb-6">
        <Card className="bg-[#1a2930] border-gray-800">
          ...
          <CardContent className="space-y-3 sm:space-y-4 p-4 sm:p-6 pt-0">
            ...
            <div className="flex items-center justify-between gap-2">
              <span className="text-xs sm:text-sm text-gray-400">Browser</span>
          ...
          <div className="flex gap-3">
            ...
            <div>
              ...
              <p className="text-xs sm:text-sm text-amber-200 leading-relaxed">
                ...
                account immediately by changing your password and reviewing your
                security settings.
              </p>
            </div>
          </div>
