...
import { getIsoFromPayloadValue } from '@/features/create-contact/helpers/create-contact-helper';

const UpdateContactPhone: FC<TUpdateFieldComponentProps> = ({
  payload,
  setPayload,
}) => {
        ...
        <div className="flex-1 px-4">
          <div className="flex items-start justify-start">
            ...
            <div className="flex-[90%] flex gap-2">
              <Select
                value={payload?.phone?.countryCode || undefined}
              ...
              >
                <SelectTrigger className="!w-[84px] !min-w-[84px] !max-w-[84px] !flex-none !rounded-[4px] !h-10 !border !border-[#747775] !outline-0">
                  <SelectValue placeholder={'Code'}>
                    <img
                      src={`https://flagcdn.com/w20/${getIsoFromPayloadValue(payload?.phone?.countryCode as string)}.png`}
                      alt={'country_code'}
...
export default UpdateContactPhone;
