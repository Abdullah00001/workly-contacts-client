      ...
      <div className="mt-2">
        {activities.map(({ activityType, createdAt, _id, location }) => (
          <div key={_id} onClick={() => router.push(`/activity/${_id}`)}>
            ...
            >
              <div className="flex flex-col min-[620px]:w-[75%] min-[620px]:flex-row min-[620px]:justify-between min-[620px]:items-center">
                <h5 className="text-[16px] font-normal  min-[620px]:w-[50%]  whitespace-nowrap">
                  {activityType}
                </h5>
              ...
              <div className="flex justify-end min-[620px]:w-[25%]">
                <ChevronRight
                  size={25}
