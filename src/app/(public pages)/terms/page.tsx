...
export const metadata: Metadata = {
  ...
  keywords: [
    'Workly Contacts terms of service',
  ...
  openGraph: {
    title: 'Terms of Service | Workly Contacts',
    description:
      'Understand the rules, responsibilities, and acceptable use of Workly Contacts. Review our Terms of Service for using the platform securely and responsibly.',
    url: 'https://contacts.workly.ink/terms',
  ...
  twitter: {
    ...
    title: 'Terms of Service | Workly Contacts',
    description:
      'Read the Workly Contacts Terms of Service. Learn about user rights, responsibilities, acceptable use, and data policies.',
  },
  robots: {
    index: true,
    follow: true,
